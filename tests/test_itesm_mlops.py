...
from server.load.load_data import DataRetriever
...
def test_missing_indicator_transform():
    ...
    data = pd.read_csv("./data/raw-data-stroke.csv")
...
def test_csv_file_existence():
    ...
    os.chdir('C:/Users/gcsanchez/Documents/GitHub/STROKE_PROJECT/server')
    csv_file_path = "./data/raw-data-stroke.csv"
    
    DATASETS_DIR = './data/'
    
    URL = 'C:/Users/gcsanchez/Documents/GitHub/SROKE_PROJECT/server/data/raw-data-stroke.csv'
